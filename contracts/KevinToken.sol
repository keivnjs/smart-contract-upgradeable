...
contract KevinToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, OwnableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {

    uint256 private _minimumSupply;

    function initialize() external initializer  {
        __ERC20_init("KevinToken", "KJS");
